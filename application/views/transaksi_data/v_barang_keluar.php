<?php if ($this->session->userdata('level') === '1' or $this->session->userdata('level') === '2') : ?>
    <a class="btn btn-primary mb-3" href="<?= base_url() ?>transaksi/t_barang_keluar_c"><i class="fa fa-plus"></i>Tambah Transaksi</a>
<?php endif; ?>
<table class="table">
    ...
    <tbody style="font-size:16px;">
        ...
        <?php foreach ($data as $dt) : ?>
            <tr>
                ...
                <td>
                    <?php echo anchor(
                            'transaksi/T_Barang_Keluar_C/transaksi_detail/' . $dt['Id_Detail'],
